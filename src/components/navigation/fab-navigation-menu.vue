<template>
  <v-container id="create">
    ...
    >
      ...
      <v-tooltip :top="tooltipDirection === 'top'"
          ...
          <v-container fluid>
            <v-row class="child-flex">
              <v-col cols="12" sm="6" md="4">
                <v-card class="pb-4">
                  <v-card-subtitle><strong>Menu Location</strong></v-card-subtitle>
                  <v-btn-toggle v-model="horizontal"
                                borderless
                                mandatory>
                    <v-btn value="left">
              ...
              <v-col cols="12" sm="6" md="4">
                <v-card class="pb-4">
                  <v-card-subtitle><strong>Menu Direction</strong></v-card-subtitle>
              ...
              <v-col cols="12" sm="6" md="4">
                ...
                <v-radio-group v-model="transition" hide-details>
                  ...
                  <img src="images/components/fab-navigation-menu-transition-slide-y.gif" class="transition"/>
                  <v-radio value="slide-y-reverse-transition" label="Slide y reverse"></v-radio>
                  <img src="images/components/fab-navigation-menu-transition-slide-y-reverse.gif" class="transition" />
                  <v-radio value="slide-x-transition" label="Slide x"></v-radio>
                  <img src="images/components/fab-navigation-menu-transition-slide-x.gif" class="transition" />
                  <v-radio value="slide-x-reverse-transition" label="Slide x reverse"></v-radio>
                  <img src="images/components/fab-navigation-menu-transition-slide-y-reverse.gif" class="transition" />
                  <v-radio value="scale-transition" label="Scale"></v-radio>
                  <img src="images/components/fab-navigation-menu-transition-slide-scale.gif" class="transition" />
                </v-radio-group>
              </v-col>
              <v-col cols="12" sm="6" md="4">
